...
//We need a system to manage household appliances with basic details like brand and power consumption. Each appliance should have the ability to be turned on or off.
...
//Create object from each appliance type and demo the display of the general and specific information. The demonstration must be performed using a variable type corresponding to the superclass(parent)
